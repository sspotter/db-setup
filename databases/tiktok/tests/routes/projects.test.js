...
describe('Projects API Endpoints', () => {
    ...
    describe('POST /api/projects', () => {
        it('should create a new project and return 201', async () => {
            ...
            // Assert the write happened, without coupling to an exact call count
            // (which breaks on any internal query refactor).
    ...
    describe('GET /api/projects/:id', () => {
        it('should return a specific project with details', async () => {
            ...
            // 2. keyword summary stats
            pool.query.mockResolvedValueOnce({ rows: [{ total_keywords: '1', active_keywords: '1', total_videos: '5', total_creators: '2', total_views: '500', total_engagement: '100', potential_reach: '500' }] });
            // 3. partners stats
    ...
    describe('DELETE /api/projects/:id', () => {
        ...
        it('should return 404 when the project is not found or not owned by the user', async () => {
            // DELETE ... WHERE id = $1 AND user_id = $2 matches nothing
